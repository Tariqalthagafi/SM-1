  ...
  <div class="social-field">
    <label class="field-label">
      <img
        ...
        class="field-icon"
      />
      {{ t('cboard.social.fields.youtube') }}
    </label>

    <input
      :type="input_type"
      v-model="inputValue"
      :placeholder="t('cboard.social.fields.youtube_placeholder')"
      @focus="on_focus"
      @blur="on_blur"
      :class="{ editing: isEditing }"
      :aria-label="t('cboard.social.fields.youtube')"
    />
